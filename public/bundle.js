...
/***/ function(module, exports, __webpack_require__) {
	...
	var marked = __webpack_require__(158);
	...
	$(document).ready(function () {
	  ...
	  var MarkdownCell = React.createClass({
	    ...
	    render: function render() {
	      return React.createElement("div", { className: "cell", dangerouslySetInnerHTML: this.rawMarkup() });
	    }
	  });
	    ...
	    render: function render() {
	      var outputs = this.props.data.outputs.map(function (output) {
	        ...
	        if (html) {
	          ...
	          return React.createElement("div", { dangerouslySetInnerHTML: code });
	        } else if (png) {
	          var inline = "data:image/png;base64," + png;
	          return React.createElement("img", { src: inline });
	        } else if (text) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "div",
	            { className: "code" },
	            this.props.data.source.join("")
	          )
	        ),
	        React.createElement(
	          "div",
	          { className: "yields" },
	          React.createElement("img", { src: "yield-arrow.png", alt: "yields" })
	        ),
	        React.createElement(
	          "div",
	          { className: "cell-label" },
	    ...
	    render: function render() {
	      ...
	      var cells = this.props.data.cells.map(function (cell) {
	        ...
	        if (cell.cell_type == "markdown") {
	          return React.createElement(MarkdownCell, { data: cell });
	        } else {
	          return React.createElement(CodeCell, { data: cell, index: index });
	        }
	      });
	      return React.createElement(
	        "div",
	  ...
	  jQuery.get("waldo.ipynb", function (data) {
	    React.render(React.createElement(Notebook, { data: data }), mountNode);
	    moveCursor(0);
	  }, "json");
	});
